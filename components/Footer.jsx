...
export default function Footer() {
	return (
		<footer className="bg-gradient-to-b from-transparent to-gray-100 py-12 mt-16">
			<div className="mx-auto max-w-6xl px-6 md:px-12 lg:px-6 xl:px-0">
				...
				<ul className="mt-12 flex flex-wrap items-center justify-center gap-4 py-4 text-gray-600 sm:gap-8">
					<li>
						<a
							href="https://vine.ao"
							target="_blank"
				...
				<div className="m-auto mt-4 flex w-max items-center justify-between space-x-4 text-gray-500">
					...
					<a
						className="duration-300 hover:text-gray-600"
						href="https://www.facebook.com/profile.php?id=61560367461985"
						title="facebook"
						target="_blank"
						aria-label="facebook"
						rel="noreferrer"
